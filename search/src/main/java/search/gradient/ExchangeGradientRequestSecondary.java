 ...
 * @author teo
 */
public class ExchangeGradientRequestSecondary extends Message {
    ...
    public ExchangeGradientRequestSecondary(PeerAddress source, PeerAddress destination, SortedSet<PeerAddress> similarSet) {
